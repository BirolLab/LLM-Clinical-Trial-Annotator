...
# Paths
# ---------------------------------------------------------------------------
# Repo-relative path to the human ground-truth dataset. This file is a DATASET
# (gitignored in the standalone build); concordance endpoints degrade gracefully
# if it is absent. Drop the CSV into docs/ to enable concordance/agreement.
CSV_PATH = Path(__file__).resolve().parents[2] / "docs" / "human_ground_truth_train_df.csv"
