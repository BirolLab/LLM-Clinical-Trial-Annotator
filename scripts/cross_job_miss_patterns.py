...
the repo-relative `results/json/` directory and joins against
`docs/human_ground_truth_train_df.csv` for GT.
...
DEFAULT_GT = REPO_ROOT / "docs" / "human_ground_truth_train_df.csv"
